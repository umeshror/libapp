def test_full_borrow_flow(client):
    ...
    mem_res = client.post("/api/v1/members/", json=member_payload)
    ...
    borrows_res = client.get(f"/api/v1/members/{member_id}/borrows/")
    ...
    borrow_res = client.post(f"/api/v1/borrows/", json=borrow_payload)
    ...
    # 5. Return Book
    return_res = client.post(f"/api/v1/borrows/{borrow_id}/return/")
